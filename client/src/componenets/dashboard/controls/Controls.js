...
import {fetchFacilities,fetchRoomTypes,fetchPolicies} from "../../../actions/filtersActions";
					...
					<FormControl className={classes.form}>
						...
						<div className={classes.selectWrapper}>
							<Select isMulti
								...
								onChange={(selected)=> {
									this.setState({selectedPolicies: selected});
									this.props.updateLocations(this.state);
								}}
							/></div>
					</FormControl>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(Controls));