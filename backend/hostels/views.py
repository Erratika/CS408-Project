...
from backend.hostels import Prices, RatingsHostel, RoomSizes, Facilities, Policies, RoomTypes, Hostel
...
class LocationsViewSet(viewsets.ReadOnlyModelViewSet):  # pylint: disable=too-many-ancestors
...
class FacilitiesViewSet(viewsets.ReadOnlyModelViewSet):  # pylint: disable=too-many-ancestors
    serializer_class = FacilitiesSerializer
    queryset = Facilities.objects.all().order_by('facility')


class PoliciesViewSet(viewsets.ReadOnlyModelViewSet):  # pylint: disable=too-many-ancestors
    queryset = Policies.objects.all().order_by('policy')
    serializer_class = PoliciesSerializer


class RoomTypesViewSet(viewsets.ReadOnlyModelViewSet):  # pylint: disable=too-many-ancestors
